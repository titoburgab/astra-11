...
window.i18nStrings.en = {
  ...
  about: {
    ...
    hero: {
      ...
      headline: 'Engineering AI. Delivering Business Results.',
      body:     'Technology alone doesn\'t transform a business. The right systems do. At ASTRA-11, we engineer AI solutions that eliminate inefficiencies, automate repetitive work, reduce costs, and help businesses operate better.',
    ...
    whoWeAre: {
      eyebrow: 'Who We Are',
      heading: 'Your AI Engineering Partner',
      ...
      body2:   'We understand how your business works, identify where AI can create value, and build systems around your existing operations.',
    ...
    whyWeExist: {
      ...
      problems: 'Every organization has hidden inefficiencies.<br>Too much manual work.<br>Information scattered across systems.<br>Repetitive tasks that should be automated.<br>Decisions slowed down by missing information.',
    ...
    different: {
      ...
      body:    'Simple principles. Consistently applied.',
      card1: { title: 'Practical Intelligence',            body: 'We build for the problem—not for the technology. If a system doesn\'t save time, reduce cost, improve decisions, or create value, we don\'t build it.' },
      card2: { title: 'Solutions Built Around You',        body: 'We design around your workflows, data, and team—not the other way around. Your business shouldn\'t have to change to fit the software.' },
      card3: { title: 'Partnership Beyond Deployment',     body: 'Our work doesn\'t end at launch. We monitor, improve, and support the systems we build as your business evolves.' },
    },
    founders: {
      eyebrow: 'Founders',
      ...
      why: {
        ...
        heading: 'Two perspectives. One problem.',
        body1:   'Tito saw technology fail because organizations couldn\'t connect systems, teams, and execution.',
        body2:   'César saw strategy fail because organizations couldn\'t connect leadership, people, and execution.',
        closer:  'ASTRA-11 brings both perspectives together.',
      },
      vision: {
        eyebrow: 'Our Shared Thesis',
        heading: 'Complexity doesn\'t disappear when you add AI.',
        body:    'It has to be engineered into a better system. That\'s what we do. That\'s enough.',
      },
      cta: {
    ...
    impact: {
      ...
      item5: { title: 'Lower operating cost',                body: 'Automation handles more work without adding more headcount.' },
    ...
    industries: {
      ...
      heading: 'We Build for the Business, Not the Industry.',
      body:    'Every industry has inefficient processes, disconnected information, and repetitive work. We focus on understanding your operation and engineering the system it needs.',
    },
    commitment: {
    ...
    cta: {
      ...
      body:      'Tell us what\'s slow, manual, or inconsistent. We\'ll tell you honestly whether AI is the right solution—and what it would take to build it properly.',
