 ...
 * register a LATAM decision-maker (CEO/COO/CTO) would expect.
 * ───────────────────────────────────────────────────────────────────────── */
...
window.i18nStrings.es = {
  ...
  credibility: {
    label:        'Sobre lo que operamos, no una lista de clientes',
  ...
  howWeWork: {
    ...
    step2: {
      title: 'Diseñar',
      body:  'La IA se adapta a cómo tu equipo ya trabaja. Diseñamos alrededor de los flujos existentes, no en torno a las limitaciones de un modelo.',
    },
    step3: {
      title: 'Construir',
  ...
  founding: {
    eyebrow: 'Socios fundadores seleccionados',
    heading: 'Construimos sistemas de IA que impulsan a las empresas.',
    body:    'La tecnología por sí sola no resuelve problemas. Los sistemas bien construidos, sí. Diseñamos IA que agiliza las operaciones, conecta el conocimiento y automatiza flujos de trabajo complejos con precisión, trabajando junto a tu equipo desde la estrategia hasta la implementación. Cada proyecto recibe atención directa a nivel senior y un enfoque sin concesiones en la calidad.',
  ...
  contact: {
    heading:     'Deja de gestionar la complejidad.<br>Empieza a operar a través de ella.',
    body:        'Cuéntanos sobre tus procesos. Evaluaremos qué vale la pena automatizar, identificaremos las oportunidades de mayor valor y te diremos con honestidad si la IA es la herramienta adecuada, antes de construir cualquier cosa.',
    form: {
      name:     'Nombre',
      email:    'Correo corporativo',
      company:  'Empresa (opcional)',
      message:  '¿Qué estás buscando resolver?',
  ...
  about: {
    ...
    hero: {
      ...
      headline: 'Ingeniería de IA. Resultados de negocio.',
      body:     'La tecnología por sí sola no transforma un negocio. Los sistemas correctos sí lo hacen. En ASTRA-11 diseñamos soluciones de IA que eliminan ineficiencias, automatizan trabajo repetitivo, reducen costos y ayudan a que tu negocio funcione mejor.',
    ...
    whoWeAre: {
      ...
      heading: 'Tu socio de ingeniería en IA',
      ...
      body2:   'Entendemos cómo funciona tu negocio, identificamos dónde la IA puede generar valor, y construimos sistemas alrededor de tus operaciones actuales.',
    ...
    whyWeExist: {
      ...
      problems: 'Toda organización tiene ineficiencias ocultas.<br>Demasiado trabajo manual.<br>Información dispersa entre sistemas.<br>Tareas repetitivas que deberían automatizarse.<br>Decisiones retrasadas por falta de información.',
    ...
    different: {
      ...
      body:    'Principios simples. Aplicados de forma constante.',
      card1: { title: 'Inteligencia Práctica',                     body: 'Construimos para el problema, no para la tecnología. Si un sistema no ahorra tiempo, reduce costos, mejora decisiones o crea valor, no lo construimos.' },
      card2: { title: 'Soluciones Construidas Para Ti',            body: 'Diseñamos alrededor de tus flujos de trabajo, datos y equipo, no al revés. Tu negocio no debería cambiar para adaptarse al software.' },
      card3: { title: 'Acompañamiento Más Allá del Lanzamiento',   body: 'Nuestro trabajo no termina en el lanzamiento. Monitoreamos, mejoramos y damos soporte a los sistemas que construimos a medida que tu negocio evoluciona.' },
    },
    founders: {
      eyebrow: 'Fundadores',
      ...
      why: {
        ...
        heading: 'Dos perspectivas. Un mismo problema.',
        body1:   'Tito vio fallar la tecnología porque las organizaciones no lograban conectar sistemas, equipos y ejecución.',
        body2:   'César vio fallar la estrategia porque las organizaciones no lograban conectar liderazgo, personas y ejecución.',
        closer:  'ASTRA-11 une ambas perspectivas.',
      },
      vision: {
        eyebrow: 'Nuestra Tesis Compartida',
        heading: 'La complejidad no desaparece cuando adoptas IA.',
        body:    'Hay que diseñarla dentro de un sistema mejor. Eso es lo que hacemos. Con eso basta.',
      },
      cta: {
    ...
    impact: {
      ...
      item5: { title: 'Menor costo operativo',                     body: 'La automatización absorbe más trabajo sin necesidad de contratar más personal.' },
    ...
    industries: {
      ...
      heading: 'Construimos para el negocio, no para la industria.',
      body:    'Todas las industrias tienen procesos ineficientes, información desconectada y trabajo repetitivo. Nos enfocamos en entender tu operación y diseñar el sistema que necesita.',
    },
    commitment: {
    ...
    cta: {
      heading:   '¿Tienes un problema de negocio que vale la pena resolver?',
      body:      'Cuéntanos qué es lento, manual o inconsistente. Te diremos con honestidad si la IA es la solución adecuada, y qué se necesitaría para construirla bien.',
